                ...
                <div className='interview-card__body'>
                    ...
                    <div className='panel panel--right'>
                        ...
                        <div className='upload-section'>
                            ...
                            <label className={`dropzone ${uploadedFile ? 'dropzone--uploaded' : ''}`} htmlFor='resume'>
                                {uploadedFile ? (
                                    <>
                                        ...
                                        <p className='dropzone__subtitle'>{(uploadedFile.size / 1024).toFixed(1)} KB &bull; Click to change</p>
                                    </>
                                ) : (
                                    <>
